    ...
    return html`
      <div class='fixed top-5 right-5 w-[300px] h-auto rounded-lg shadow-md bg-white flex flex-col gap-2 px-2 py-4'>
        ...
        <div class='flex flex-col gap-2 justify-center w-full'>
          ...
          <selector-component .placeholder=${'Select an database'} .selectedOption=${this.selectedOption} .onSelect=${(o: DatabaseInfo) => this.handleSelect(o)} .options=${this.options}></selector-component>
        </div>
